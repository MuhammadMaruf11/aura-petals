...
const reasons = [
  {
    ...
    description: "Every piece is shaped, glazed, and finished by hand in small batches.",
  },
  {
    icon: Gift,
    title: "Made to be personal",
    description: "Add names, dates, and messages to turn a piece into a keepsake.",
  },
  {
    icon: ShieldCheck,
  ...
  return (
    <section className="bg-sand py-16">
      <div className="container-boutique">
        <h2 className="mb-10 text-center font-heading text-3xl">Why Aura &amp; Petals</h2>
...
export function Testimonials() {
  return (
    <section className="container-boutique py-16">
      <h2 className="mb-10 text-center font-heading text-3xl">Loved by our customers</h2>
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        {testimonials.map((t) => (
          <figure key={t.name} className="rounded-2xl border border-border/70 bg-card p-6">
