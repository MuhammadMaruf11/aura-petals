      ...
      <Card className="group relative overflow-hidden border-none bg-transparent shadow-none gap-0">
        <CardContent className="p-0 relative aspect-4/5 overflow-hidden border-none bg-muted">
          ...
          <Image
            ...
            priority={isElite} // Elite products get priority loading for better LCP
          />

          {/* Hover Overlay with ProductActions */}
          <div className="absolute left-1/2 -translate-x-1/2 bottom-5 curspo bg-black/10 opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center backdrop-blur-[2px]">
            <ProductActions
