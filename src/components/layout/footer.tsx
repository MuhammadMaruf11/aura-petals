...
export function Footer() {
  return (
    <footer className="mt-24 border-t border-border/70 bg-sand print:hidden">
      <div className="container-boutique grid gap-10 py-16 md:grid-cols-4">
        <div className="space-y-3 md:col-span-1">
          ...
          <div className="flex gap-3 pt-2">
            <Link href={siteConfig.links.instagram} aria-label="Instagram" className="text-muted-foreground hover:text-primary">
              <Camera className="size-5" />
            </Link>
            <Link href={siteConfig.links.facebook} aria-label="Facebook" className="text-muted-foreground hover:text-primary">
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li><Link href="/account/orders" className="hover:text-primary">Track an order</Link></li>
